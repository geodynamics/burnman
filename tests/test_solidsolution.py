...
class two_site_ss(burnman.SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.type = 'symmetric'
        self.endmembers = [[forsterite(), '[Mg]3[Al]2Si3O12'], [forsterite(
        ), '[Fe]3[Al]2Si3O12'], [forsterite(), '[Mg]3[Mg1/2Si1/2]2Si3O12']]
...
class test_solidsolution(BurnManTest):
    ...
    def test_site_totals(self):
        ...
        site_fractions = np.dot(
            ss.molar_fractions,
            ss.solution_model.endmember_occupancies)
        i = 0
        site_fill = []
    ...
    def test_molar_mass(self):
        ...
        self.assertArraysAlmostEqual([ss.molar_mass], [
                                     0.5 * forsterite().params['molar_mass'] + 0.5 * fayalite().params['molar_mass']])
    ...
    def test_subregular(self):
        ...
        self.assertArraysAlmostEqual(
            ss0.excess_partial_gibbs,
            ss1.excess_partial_gibbs)
