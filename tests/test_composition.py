...
class composition(BurnManTest):
    ...
    def test_molar_no_normalize(self):
        ...
        self.assertArraysAlmostEqual(list(c_dict.values()),
    ...
    def test_molar_normalize(self):
        ...
        c_fractions = (np.array(list(c_dict.values()))
                       / sum(list(c_dict.values())))
        self.assertArraysAlmostEqual(c_fractions,
                                     c.molar_composition.values())
    ...
    def test_add_component_molar(self):
        ...
        self.assertArraysAlmostEqual(np.array(list(c_dict.values()))*2.,
                                     c.molar_composition.values())
    ...
    def test_change_component_set(self):
        ...
        self.assertArraysAlmostEqual(np.array(list(c_dict.values())),
                                     c.molar_composition.values())
