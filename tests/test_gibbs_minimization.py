...
class Minimization(BurnManTest):
    ...
    def test_minimizer(self):
        sol = gibbs_minimizer(sillimanite.params['formula'], assemblage, [['T', 800.], ['X', [1., 0.], [1., 1.], 0.]])
        self.assertArraysAlmostEqual((sol['c'] - np.array([0., 1.]))/1.e6, [0., 0.])
 
    def test_bulk_minimizer(self):
        constraints = [['T', 1600.], ['P', 8.e9], ['X', [0., 0., 1., 0.], [1., 0., 1., 0.], 0.]]
        sol = gibbs_bulk_minimizer(fo.params['formula'], fa.params['formula'], 0.71, assemblage2, constraints)
    ...
    def test_invariant(self):
        ...
        PT1 = find_invariant(sillimanite.params['formula'], [andalusite], [sillimanite, kyanite])
    ...
    def test_univariant(self):
        ...
        P1 = find_univariant(sillimanite.params['formula'], [sillimanite], andalusite, 'T', [800.])[0]
