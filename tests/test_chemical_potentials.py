...
class ChemicalPotentials(BurnManTest):
    ...
    def test_chemical_potentials(self):
        ...
        mu_SiO2 = burnman.chemicalpotentials.chemical_potentials(assemblage, [{'Si': 1., 'O': 2.}])[0]
    ...
    def test_relative_fugacity(self):
        ...
        relative_fugacity = burnman.chemicalpotentials.relative_fugacity(stv, assemblage, assemblage)
