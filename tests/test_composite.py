...
class composite(BurnManTest):
    ...
    def test_changevalues(self):
        ...
        self.assertEqual(mins, ",".join([minerals.Murakami_etal_2012.fe_periclase(
        ).to_string(), minerals.SLB_2005.periclase().to_string()]))
    ...
    def test_velocities_from_rock(self):
        ...
        _, _, _, _, K, G = burnman.velocities_from_rock(
            rock, [
                40.e9, ], [
                2000., ], averaging_scheme=burnman.averaging_schemes.HashinShtrikmanAverage())
    ...
    def test_query_properties(self):
        ...
        self.assertFloatEqual(
            rock1.isothermal_bulk_modulus,
            min1.params['K_0'])
        self.assertFloatEqual(
            rock1.isothermal_compressibility,
            1. / min1.params['K_0'])
        self.assertFloatEqual(
            rock1.adiabatic_compressibility,
            1. / rock1.adiabatic_bulk_modulus)
        self.assertFloatEqual(
            rock1.grueneisen_parameter,
            min1.params['grueneisen_0'])
