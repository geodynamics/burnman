...
plt.plot( 1.0-np.array([invariant[1], invariant[2], invariant[3]]), np.array([invariant[0], invariant[0], invariant[0]])/1.e9, color='black', linewidth=2, label='invariant')

plt.plot( 1.0-XMgA_ol_wad, P_ol_wad/1.e9, 'r-', linewidth=2, label='wad-out (ol, wad)')
plt.plot( 1.0-XMgB_ol_wad, P_ol_wad/1.e9, 'g-', linewidth=2, label='ol-out (ol, wad)')

plt.plot( 1.0-XMgA_ol_rw, P_ol_rw/1.e9, 'r-',  linewidth=2, label='rw-out (ol, rw)')
plt.plot( 1.0-XMgB_ol_rw, P_ol_rw/1.e9, 'b-',  linewidth=2, label='ol-out (ol, rw)')

plt.plot( 1.0-XMgA_wad_rw, P_wad_rw/1.e9, 'g-',  linewidth=2, label='rw-out (wad, rw)')
plt.plot( 1.0-XMgB_wad_rw, P_wad_rw/1.e9, 'b-',  linewidth=2, label='wad-out (wad, rw)')
