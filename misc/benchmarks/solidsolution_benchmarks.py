...
for i, c in enumerate(comp):
    ...
    sp_entropies_NK1967[i] = -8.3145 * (c * np.log(c) + (1. - c) * np.log(
        1. - c) + c * np.log(c / 2.) + (2. - c) * np.log(1. - c / 2.))
...
# Uncomment these two lines if you want to overlay the plot on a
# screengrab from SLB2011
