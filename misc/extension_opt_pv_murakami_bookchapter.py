...
#    plt.rc('font', family='sanserif')
    ...
    def eval_material(amount_perovskite):
        ...
        rock = burnman.composite ( [ (minerals.Murakami_2013.mg_fe_perovskite(0.06), amount_perovskite),
                             (minerals.Murakami_2013.ferropericlase(0.21), 1.0 - amount_perovskite) ] )
...
#                             (minerals.SLB_2011.ferropericlase(1.0), 1.0 - amount_perovskite) ] )
 ...
 #   plt.figure(dpi=100,figsize=figsize)
    ...
    plt.plot (xx*100,yy_vphi,"-",color=colors.color(3),label=("$V_\phi$ error"),linewidth=1.5)
...
#    plt.tight_layout()
    plt.savefig("extension_opt_pv_murakami_bookchapter.pdf",bbox_inches='tight')
    plt.show()
