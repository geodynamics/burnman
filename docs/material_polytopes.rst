...
Often in mineral physics, material compositions,
solution compositions, or solution site-occupancies are subject to a set of
linear constraints.
...
Please see :ref:`ref-api-polytopes` for full documentation.
