...
.. class:: Material
    ...
    in BurnMan, including :ref:`ref-materials-mineral` (:class:`burnman.Mineral`),
    :ref:`ref-materials-solution` (:class:`burnman.Solution`),
    and :ref:`ref-materials-composite` (:class:`burnman.Composite`).
