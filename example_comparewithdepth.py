...
# set anchor temperature for adiabat
T0=1900
...
#Here we compute the self-consistent pressures
pressures=burnman.pressures_for_rock(rock,depths,T0)
...
temperature=burnman.geotherm.adiabatic(pressures,T0,rock)
density, vp, vs, vphi, K, G = burnman.velocities_from_rock(rock, pressures, temperature)
...
plt.plot(depths/1.e3,seis_vs/1.e3,color='k',linestyle='-',marker='o', markerfacecolor='k',markersize=4,label='reference')
...
plt.plot(depths/1.e3,seis_vp/1.e3,color='k',linestyle='-',marker='o',markerfacecolor='k',markersize=4)
...
plt.plot(depths/1.e3,seis_rho/1.e3,color='k',linestyle='-',marker='o', markerfacecolor='k',markersize=4)
plt.xlim(min(depths)/1.e3,max(depths)/1.e3)
plt.xlabel("Depth (km)")
...
plt.subplot(2,2,4)
plt.plot(depths/1.e3,temperature,color='r',linestyle='-',marker='o',markerfacecolor='r',markersize=4)
plt.xlim(min(depths)/1.e3,max(depths)/1.e3)
plt.xlabel("Depth (km)")
