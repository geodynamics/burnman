...
def average_moduli(moduli_list, averaging_scheme=burnman.averaging_schemes.voigt_reuss_hill):
    """
...
def velocities_from_rock(rock, pressures, temperatures, averaging_scheme=burnman.averaging_schemes.voigt_reuss_hill()):
    """
...
def depths_for_rock(rock,pressures, temperatures,averaging_scheme=burnman.averaging_schemes.voigt_reuss_hill()):
    """
...
def pressures_for_rock(rock, depths, T0, averaging_scheme=burnman.averaging_schemes.voigt_reuss_hill()):
    """
