...
def average_moduli(moduli_list, averaging_scheme=averaging_schemes.VoigtReussHill):
    """
...
def depths_for_rock(rock,pressures, temperatures,averaging_scheme=averaging_schemes.VoigtReussHill()):
    """
...
def pressures_for_rock(rock, depths, T0, averaging_scheme=averaging_schemes.VoigtReussHill()):
    """
    ...
    pressures = seismic_model.evaluate(['pressure'], depths)
    pressref = np.zeros_like(pressures)
