...
class lrn (Mineral):
    def __init__(self):
        ...
        self.property_modifiers = [[
            'landau_hp', {'Tc': 1710.0 , 'S_D': 10.03 , 'V_D': 5e-07 }]]
        Mineral.__init__(self)
...
class sph (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 485.0 , 'S_D': 0.4 , 'V_D': 5e-08 }]]
        Mineral.__init__(self)
...
class q (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 847.0 , 'S_D': 4.95 , 'V_D': 1.188e-06 }]]
        Mineral.__init__(self)
...
class ne (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 467.0 , 'S_D': 10.0 , 'V_D': 8e-07 }]]
        Mineral.__init__(self)
...
class hem (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 955.0 , 'S_D': 15.6 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class NiO (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 520.0 , 'S_D': 5.7 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class ilm (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 1900.0 , 'S_D': 12.0 , 'V_D': 2e-07 }]]
        Mineral.__init__(self)
...
class mt (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 848.0 , 'S_D': 35.0 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class mft (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 665.0 , 'S_D': 17.0 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class cc (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 1240.0 , 'S_D': 10.0 , 'V_D': 4e-07 }]]
        Mineral.__init__(self)
...
class trot (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 598.0 , 'S_D': 12.0 , 'V_D': 4.1e-07 }]]
        Mineral.__init__(self)
...
class lot (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 420.0 , 'S_D': 10.0 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class trov (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 595.0 , 'S_D': 10.0 , 'V_D': 1.6e-07 }]]
        Mineral.__init__(self)
...
class iron (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 1042.0 , 'S_D': 8.3 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
...
class Ni (Mineral):
    def __init__(self):
        ...
        self.params = {
            ...
            'n': sum(formula.values()),
        self.property_modifiers = [[
            'landau_hp', {'Tc': 631.0 , 'S_D': 3.0 , 'V_D': 0.0 }]]
        Mineral.__init__(self)
