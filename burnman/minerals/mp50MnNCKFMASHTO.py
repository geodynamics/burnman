...
anC = CombinedMineral([HP_2011_ds62.an()], [1.0], [7030.0, 4.66, 0.0], "anC")
mut = CombinedMineral([HP_2011_ds62.mu()], [1.0], [1000.0, -0.0, 0.0], "mut")
celt = CombinedMineral([HP_2011_ds62.cel()], [1.0], [5000.0, -0.0, 0.0], "celt")
fcelt = CombinedMineral([HP_2011_ds62.fcel()], [1.0], [5000.0, -0.0, 0.0], "fcelt")
pat = CombinedMineral([HP_2011_ds62.pa()], [1.0], [4000.0, -0.0, 0.0], "pat")
fmu = CombinedMineral(
...
mat = CombinedMineral([HP_2011_ds62.ma()], [1.0], [5000.0, -0.0, 0.0], "mat")
fmu = CombinedMineral(
...
mmbi = CombinedMineral([HP_2011_ds62.mnbi()], [1.0], [-7890.0, -0.0, 0.0], "mmbi")
fm = CombinedMineral(
...
mnopx = CombinedMineral([HP_2011_ds62.pxmn()], [2.0], [6680.0, -0.0, 0.0], "mnopx")
odi = CombinedMineral(
...
mncd = CombinedMineral([HP_2011_ds62.mncrd()], [1.0], [-4210.0, -0.0, 0.0], "mncd")
mstm = CombinedMineral([HP_2011_ds62.mst()], [1.0], [-8000.0, -0.0, 0.0], "mstm")
mnstm = CombinedMineral([HP_2011_ds62.mnst()], [1.0], [-190.0, -0.0, 0.0], "mnstm")
...
mmchl = CombinedMineral([HP_2011_ds62.mnchl()], [1.0], [-5670.0, -0.0, 0.0], "mmchl")
mnct = CombinedMineral([HP_2011_ds62.mnctd()], [1.0], [660.0, -0.0, 0.0], "mnct")
...
imt = CombinedMineral(
    [mt_nood], [1.0], [16874.42602715333, 25.01732526713637, 0.0], "imt"
)
dmt = CombinedMineral(
    [mt_nood], [1.0], [20064.42602715333, 29.36782526713637, 0.0], "dmt"
)
...
class ma(Solution):
    def __init__(self, molar_fractions=None):
        ...
        self.solution_model = AsymmetricRegularSolution(
            endmembers=[
                [mut, "[Ka][Alma][Almb][Sit1/2Alt1/2]2"],
                [celt, "[Ka][Mgma][Almb][Sit]2"],
                [fcelt, "[Ka][Fema][Almb][Sit]2"],
                [pat, "[Naa][Alma][Almb][Sit1/2Alt1/2]2"],
                [HP_2011_ds62.ma(), "[Caa][Alma][Almb][Alt]2"],
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.solution_model = SymmetricRegularSolution(
            endmembers=[
                ...
                [mmbi, "[Mnm][Mnm]2[Sit1/2Alt1/2]2[Ohv]2"],
            ],
            energy_interaction=[
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.solution_model = SymmetricRegularSolution(
            endmembers=[
                ...
                [mmchl, "[Mnm][Mnm]4[Alm][Sit1/2Alt1/2]2"],
            ],
            energy_interaction=[
...
class ctd(Solution):
    def __init__(self, molar_fractions=None):
        ...
        self.solution_model = SymmetricRegularSolution(
            endmembers=[
                [HP_2011_ds62.mctd(), "[Alma]1/2[Mgmb]"],
                [HP_2011_ds62.fctd(), "[Alma]1/2[Femb]"],
                [mnct, "[Alma]1/2[Mnmb]"],
                [ctdo, "[Fema]1/2[Mgmb]"],
            ],
...
class mt1(Solution):
    def __init__(self, molar_fractions=None):
        ...
        self.solution_model = SymmetricRegularSolution(
            endmembers=[
                [imt, "[Fem1/2Fem1/2]2[Fet]"],
                [dmt, "[Fem2/3Fem1/3]2[Fet2/3Fet1/3]"],
