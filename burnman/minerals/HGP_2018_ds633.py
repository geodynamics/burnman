...
class mont (Mineral):
    def __init__(self):
        self.params = {'name': 'mont',
                       'formula': {'Ca': 1.0, 'Si': 1.0, 'Mg': 1.0, 'O': 4.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2251230.0,
                       'S_0': 109.5,
                       'V_0': 5.148e-05,
...
class chum (Mineral):
    def __init__(self):
        self.params = {'name': 'chum',
                       'formula': {'H': 2.0, 'Mg': 9.0, 'Si': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9613220.0,
                       'S_0': 440.5,
                       'V_0': 0.00019801,
...
class chdr (Mineral):
    def __init__(self):
        self.params = {'name': 'chdr',
                       'formula': {'H': 2.0, 'Mg': 5.0, 'Si': 2.0, 'O': 10.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5254760.0,
                       'S_0': 260.0,
                       'V_0': 0.00011084,
...
class npv (Mineral):
    def __init__(self):
        self.params = {'name': 'npv',
                       'formula': {'Na': 0.5, 'Si': 1.0, 'Al': 0.5, 'O': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -1365000.0,
                       'S_0': 63.0,
                       'V_0': 2.334e-05,
...
class nagt (Mineral):
    def __init__(self):
        self.params = {'name': 'nagt',
                       'formula': {'Na': 1.0, 'Mg': 2.0, 'Si': 4.0, 'Al': 1.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5985000.0,
                       'S_0': 260.6,
                       'V_0': 0.0001109,
...
class py (Mineral):
    def __init__(self):
        self.params = {'name': 'py',
                       'formula': {'Mg': 3.0, 'Si': 3.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6284740.0,
                       'S_0': 267.0,
                       'V_0': 0.00011313,
...
class alm (Mineral):
    def __init__(self):
        self.params = {'name': 'alm',
                       'formula': {'Si': 3.0, 'Fe': 3.0, 'O': 12.0, 'Al': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5267060.0,
                       'S_0': 337.0,
                       'V_0': 0.00011525,
...
class spss (Mineral):
    def __init__(self):
        self.params = {'name': 'spss',
                       'formula': {'Si': 3.0, 'Mn': 3.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5692410.0,
                       'S_0': 335.3,
                       'V_0': 0.00011792,
...
class gr (Mineral):
    def __init__(self):
        self.params = {'name': 'gr',
                       'formula': {'Ca': 3.0, 'Si': 3.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6642910.0,
                       'S_0': 255.0,
                       'V_0': 0.00012535,
...
class andr (Mineral):
    def __init__(self):
        self.params = {'name': 'andr',
                       'formula': {'Ca': 3.0, 'Si': 3.0, 'Fe': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5768870.0,
                       'S_0': 316.4,
                       'V_0': 0.00013204,
...
class knor (Mineral):
    def __init__(self):
        self.params = {'name': 'knor',
                       'formula': {'Cr': 2.0, 'Mg': 3.0, 'Si': 3.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5701180.0,
                       'S_0': 302.0,
                       'V_0': 0.00011738,
...
class uv (Mineral):
    def __init__(self):
        self.params = {'name': 'uv',
                       'formula': {'Cr': 2.0, 'Ca': 3.0, 'Si': 3.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6057590.0,
                       'S_0': 320.9,
                       'V_0': 0.00013077,
...
class osma (Mineral):
    def __init__(self):
        self.params = {'name': 'osma',
                       'formula': {'K': 1.0, 'Si': 10.0, 'Mg': 2.0, 'O': 30.0, 'Al': 5.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14896020.0,
                       'S_0': 755.0,
                       'V_0': 0.00037893,
...
class osmm (Mineral):
    def __init__(self):
        self.params = {'name': 'osmm',
                       'formula': {'K': 1.0, 'Si': 11.0, 'Mg': 3.0, 'O': 30.0, 'Al': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14786240.0,
                       'S_0': 740.0,
                       'V_0': 0.0003844,
...
class osfa (Mineral):
    def __init__(self):
        self.params = {'name': 'osfa',
                       'formula': {'K': 1.0, 'Si': 10.0, 'Fe': 2.0, 'O': 30.0, 'Al': 5.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14215310.0,
                       'S_0': 780.0,
                       'V_0': 0.0003845,
...
class vsv (Mineral):
    def __init__(self):
        self.params = {'name': 'vsv',
                       'formula': {'Mg': 2.0, 'H': 9.0, 'Ca': 19.0, 'Al': 11.0, 'O': 78.0, 'Si': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -42345130.0,
                       'S_0': 1890.0,
                       'V_0': 0.000852,
...
class tpz (Mineral):
    def __init__(self):
        self.params = {'name': 'tpz',
                       'formula': {'H': 2.0, 'Si': 1.0, 'Al': 2.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2900640.0,
                       'S_0': 100.5,
                       'V_0': 5.339e-05,
...
class mst (Mineral):
    def __init__(self):
        self.params = {'name': 'mst',
                       'formula': {'H': 4.0, 'Mg': 4.0, 'Si': 7.5, 'Al': 18.0, 'O': 48.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -25122970.0,
                       'S_0': 910.0,
                       'V_0': 0.0004426,
...
class fst (Mineral):
    def __init__(self):
        self.params = {'name': 'fst',
                       'formula': {'H': 4.0, 'Si': 7.5, 'Fe': 4.0, 'O': 48.0, 'Al': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -23755130.0,
                       'S_0': 1010.0,
                       'V_0': 0.0004488,
...
class mnst (Mineral):
    def __init__(self):
        self.params = {'name': 'mnst',
                       'formula': {'H': 4.0, 'Si': 7.5, 'Mn': 4.0, 'Al': 18.0, 'O': 48.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -24242690.0,
                       'S_0': 1034.0,
                       'V_0': 0.0004546,
...
class mctd (Mineral):
    def __init__(self):
        self.params = {'name': 'mctd',
                       'formula': {'H': 2.0, 'Mg': 1.0, 'Si': 1.0, 'Al': 2.0, 'O': 7.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3549210.0,
                       'S_0': 146.0,
                       'V_0': 6.875e-05,
...
class fctd (Mineral):
    def __init__(self):
        self.params = {'name': 'fctd',
                       'formula': {'H': 2.0, 'Si': 1.0, 'Fe': 1.0, 'O': 7.0, 'Al': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3208500.0,
                       'S_0': 167.0,
                       'V_0': 6.98e-05,
...
class mnctd (Mineral):
    def __init__(self):
        self.params = {'name': 'mnctd',
                       'formula': {'H': 2.0, 'Si': 1.0, 'Mn': 1.0, 'Al': 2.0, 'O': 7.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3335510.0,
                       'S_0': 166.0,
                       'V_0': 7.175e-05,
...
class merw (Mineral):
    def __init__(self):
        self.params = {'name': 'merw',
                       'formula': {'Ca': 3.0, 'Si': 2.0, 'Mg': 1.0, 'O': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4545690.0,
                       'S_0': 253.1,
                       'V_0': 9.847e-05,
...
class spu (Mineral):
    def __init__(self):
        self.params = {'name': 'spu',
                       'formula': {'C': 1.0, 'Ca': 5.0, 'Si': 2.0, 'O': 11.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5846800.0,
                       'S_0': 332.0,
                       'V_0': 0.00014697,
...
class zo (Mineral):
    def __init__(self):
        self.params = {'name': 'zo',
                       'formula': {'H': 1.0, 'Ca': 2.0, 'Si': 3.0, 'Al': 3.0, 'O': 13.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6896150.0,
                       'S_0': 298.0,
                       'V_0': 0.00013575,
...
class ep (Mineral):
    def __init__(self):
        self.params = {'name': 'ep',
                       'formula': {'H': 1.0, 'Ca': 2.0, 'Al': 2.0, 'O': 13.0, 'Si': 3.0, 'Fe': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6473650.0,
                       'S_0': 315.0,
                       'V_0': 0.0001392,
...
class fep (Mineral):
    def __init__(self):
        self.params = {'name': 'fep',
                       'formula': {'H': 1.0, 'Ca': 2.0, 'Al': 1.0, 'O': 13.0, 'Si': 3.0, 'Fe': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6028290.0,
                       'S_0': 329.0,
                       'V_0': 0.0001421,
...
class pmt (Mineral):
    def __init__(self):
        self.params = {'name': 'pmt',
                       'formula': {'H': 1.0, 'Ca': 2.0, 'Mn': 1.0, 'Al': 2.0, 'O': 13.0, 'Si': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6542600.0,
                       'S_0': 340.0,
                       'V_0': 0.0001382,
...
class law (Mineral):
    def __init__(self):
        self.params = {'name': 'law',
                       'formula': {'H': 4.0, 'Ca': 1.0, 'Si': 2.0, 'Al': 2.0, 'O': 10.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4868550.0,
                       'S_0': 229.0,
                       'V_0': 0.00010132,
...
class mpm (Mineral):
    def __init__(self):
        self.params = {'name': 'mpm',
                       'formula': {'Mg': 1.0, 'H': 7.0, 'Ca': 4.0, 'Al': 5.0, 'O': 28.0, 'Si': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14386650.0,
                       'S_0': 629.0,
                       'V_0': 0.0002955,
...
class fpm (Mineral):
    def __init__(self):
        self.params = {'name': 'fpm',
                       'formula': {'H': 7.0, 'Ca': 4.0, 'Al': 5.0, 'O': 28.0, 'Si': 6.0, 'Fe': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14034030.0,
                       'S_0': 657.0,
                       'V_0': 0.0002968,
...
class jgd (Mineral):
    def __init__(self):
        self.params = {'name': 'jgd',
                       'formula': {'H': 7.0, 'Ca': 4.0, 'Si': 6.0, 'Fe': 6.0, 'O': 28.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -11808710.0,
                       'S_0': 830.0,
                       'V_0': 0.0003108,
...
class geh (Mineral):
    def __init__(self):
        self.params = {'name': 'geh',
                       'formula': {'Ca': 2.0, 'Si': 1.0, 'Al': 2.0, 'O': 7.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3992180.0,
                       'S_0': 198.5,
                       'V_0': 9.024e-05,
...
class ak (Mineral):
    def __init__(self):
        self.params = {'name': 'ak',
                       'formula': {'Ca': 2.0, 'Si': 2.0, 'Mg': 1.0, 'O': 7.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3865580.0,
                       'S_0': 212.5,
                       'V_0': 9.254e-05,
...
class ty (Mineral):
    def __init__(self):
        self.params = {'name': 'ty',
                       'formula': {'C': 2.0, 'Ca': 5.0, 'Si': 2.0, 'O': 13.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6368130.0,
                       'S_0': 390.0,
                       'V_0': 0.00017039,
...
class crd (Mineral):
    def __init__(self):
        self.params = {'name': 'crd',
                       'formula': {'Mg': 2.0, 'Si': 5.0, 'Al': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9163180.0,
                       'S_0': 404.1,
                       'V_0': 0.00023322,
...
class hcrd (Mineral):
    def __init__(self):
        self.params = {'name': 'hcrd',
                       'formula': {'H': 2.0, 'Mg': 2.0, 'Si': 5.0, 'Al': 4.0, 'O': 19.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9448270.0,
                       'S_0': 483.0,
                       'V_0': 0.00023322,
...
class fcrd (Mineral):
    def __init__(self):
        self.params = {'name': 'fcrd',
                       'formula': {'Si': 5.0, 'Fe': 2.0, 'O': 18.0, 'Al': 4.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -8444070.0,
                       'S_0': 461.0,
                       'V_0': 0.0002371,
...
class mncrd (Mineral):
    def __init__(self):
        self.params = {'name': 'mncrd',
                       'formula': {'Si': 5.0, 'Mn': 2.0, 'Al': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -8692150.0,
                       'S_0': 473.0,
                       'V_0': 0.00024027,
...
class phA (Mineral):
    def __init__(self):
        self.params = {'name': 'phA',
                       'formula': {'H': 6.0, 'Mg': 7.0, 'Si': 2.0, 'O': 14.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -7129610.0,
                       'S_0': 350.5,
                       'V_0': 0.00015422,
...
class phD (Mineral):
    def __init__(self):
        self.params = {'name': 'phD',
                       'formula': {'H': 2.0, 'Mg': 1.0, 'Si': 2.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2670160.0,
                       'S_0': 111.2,
                       'V_0': 5.103e-05,
...
class phE (Mineral):
    def __init__(self):
        self.params = {'name': 'phE',
                       'formula': {'H': 2.4, 'Mg': 2.4, 'Si': 1.2, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2931150.0,
                       'S_0': 169.0,
                       'V_0': 6.435e-05,
...
class shB (Mineral):
    def __init__(self):
        self.params = {'name': 'shB',
                       'formula': {'H': 4.0, 'Mg': 10.0, 'Si': 3.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9477320.0,
                       'S_0': 396.0,
                       'V_0': 0.00018615,
...
class sph (Mineral):
    def __init__(self):
        self.params = {'name': 'sph',
                       'formula': {'Ca': 1.0, 'Si': 1.0, 'O': 5.0, 'Ti': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2601450.0,
                       'S_0': 124.0,
                       'V_0': 5.565e-05,
...
class mgts (Mineral):
    def __init__(self):
        self.params = {'name': 'mgts',
                       'formula': {'Mg': 1.0, 'Si': 1.0, 'Al': 2.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3200660.0,
                       'S_0': 128.5,
                       'V_0': 6.05e-05,
...
class di (Mineral):
    def __init__(self):
        self.params = {'name': 'di',
                       'formula': {'Ca': 1.0, 'Si': 2.0, 'Mg': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3201780.0,
                       'S_0': 142.9,
                       'V_0': 6.619e-05,
...
class hed (Mineral):
    def __init__(self):
        self.params = {'name': 'hed',
                       'formula': {'Ca': 1.0, 'Si': 2.0, 'Fe': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2841970.0,
                       'S_0': 175.0,
                       'V_0': 6.795e-05,
...
class jd (Mineral):
    def __init__(self):
        self.params = {'name': 'jd',
                       'formula': {'Na': 1.0, 'Si': 2.0, 'Al': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3025370.0,
                       'S_0': 133.5,
                       'V_0': 6.04e-05,
...
class kjd (Mineral):
    def __init__(self):
        self.params = {'name': 'kjd',
                       'formula': {'K': 1.0, 'Si': 2.0, 'Al': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2932700.0,
                       'S_0': 141.24,
                       'V_0': 6.479e-05,
...
class acm (Mineral):
    def __init__(self):
        self.params = {'name': 'acm',
                       'formula': {'Na': 1.0, 'Si': 2.0, 'Fe': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2583270.0,
                       'S_0': 170.6,
                       'V_0': 6.459e-05,
...
class kos (Mineral):
    def __init__(self):
        self.params = {'name': 'kos',
                       'formula': {'Na': 1.0, 'Si': 2.0, 'O': 6.0, 'Cr': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2744890.0,
                       'S_0': 149.65,
                       'V_0': 6.309e-05,
...
class cats (Mineral):
    def __init__(self):
        self.params = {'name': 'cats',
                       'formula': {'Ca': 1.0, 'Si': 1.0, 'Al': 2.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3310050.0,
                       'S_0': 135.0,
                       'V_0': 6.356e-05,
...
class caes (Mineral):
    def __init__(self):
        self.params = {'name': 'caes',
                       'formula': {'Ca': 0.5, 'Si': 2.0, 'Al': 1.0, 'O': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3001960.0,
                       'S_0': 127.0,
                       'V_0': 6.05e-05,
...
class tr (Mineral):
    def __init__(self):
        self.params = {'name': 'tr',
                       'formula': {'H': 2.0, 'Ca': 2.0, 'Si': 8.0, 'Mg': 5.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12304300.0,
                       'S_0': 553.0,
                       'V_0': 0.0002727,
...
class fact (Mineral):
    def __init__(self):
        self.params = {'name': 'fact',
                       'formula': {'H': 2.0, 'Ca': 2.0, 'Si': 8.0, 'Fe': 5.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -10503600.0,
                       'S_0': 710.0,
                       'V_0': 0.0002842,
...
class ts (Mineral):
    def __init__(self):
        self.params = {'name': 'ts',
                       'formula': {'Mg': 3.0, 'H': 2.0, 'Ca': 2.0, 'Al': 4.0, 'O': 24.0, 'Si': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12554640.0,
                       'S_0': 533.0,
                       'V_0': 0.000268,
...
class parg (Mineral):
    def __init__(self):
        self.params = {'name': 'parg',
                       'formula': {'Mg': 4.0, 'Na': 1.0, 'Ca': 2.0, 'Al': 3.0, 'O': 24.0, 'Si': 6.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12664760.0,
                       'S_0': 635.0,
                       'V_0': 0.0002719,
...
class gl (Mineral):
    def __init__(self):
        self.params = {'name': 'gl',
                       'formula': {'Mg': 3.0, 'Na': 2.0, 'Al': 2.0, 'O': 24.0, 'Si': 8.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -11955920.0,
                       'S_0': 530.0,
                       'V_0': 0.0002598,
...
class fgl (Mineral):
    def __init__(self):
        self.params = {'name': 'fgl',
                       'formula': {'Na': 2.0, 'Al': 2.0, 'O': 24.0, 'Si': 8.0, 'Fe': 3.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -10879520.0,
                       'S_0': 624.0,
                       'V_0': 0.0002659,
...
class nyb (Mineral):
    def __init__(self):
        self.params = {'name': 'nyb',
                       'formula': {'Mg': 3.0, 'Na': 3.0, 'Al': 3.0, 'O': 24.0, 'Si': 7.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12165450.0,
                       'S_0': 622.0,
                       'V_0': 0.00026314,
...
class rieb (Mineral):
    def __init__(self):
        self.params = {'name': 'rieb',
                       'formula': {'Na': 2.0, 'Si': 8.0, 'Fe': 5.0, 'O': 24.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -10024100.0,
                       'S_0': 695.0,
                       'V_0': 0.0002749,
...
class anth (Mineral):
    def __init__(self):
        self.params = {'name': 'anth',
                       'formula': {'H': 2.0, 'Mg': 7.0, 'Si': 8.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12065900.0,
                       'S_0': 537.0,
                       'V_0': 0.0002654,
...
class fanth (Mineral):
    def __init__(self):
        self.params = {'name': 'fanth',
                       'formula': {'H': 2.0, 'Si': 8.0, 'Fe': 7.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9623750.0,
                       'S_0': 725.0,
                       'V_0': 0.0002787,
...
class ged (Mineral):
    def __init__(self):
        self.params = {'name': 'ged',
                       'formula': {'H': 2.0, 'Mg': 5.0, 'Si': 6.0, 'Al': 4.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12306610.0,
                       'S_0': 535.0,
                       'V_0': 0.00025956,
...
class spr4 (Mineral):
    def __init__(self):
        self.params = {'name': 'spr4',
                       'formula': {'Mg': 4.0, 'Si': 2.0, 'Al': 8.0, 'O': 20.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -11020350.0,
                       'S_0': 425.5,
                       'V_0': 0.000199,
...
class spr5 (Mineral):
    def __init__(self):
        self.params = {'name': 'spr5',
                       'formula': {'Mg': 3.0, 'Si': 1.0, 'Al': 10.0, 'O': 20.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -11135050.0,
                       'S_0': 419.5,
                       'V_0': 0.0001975,
...
class fspr (Mineral):
    def __init__(self):
        self.params = {'name': 'fspr',
                       'formula': {'Si': 2.0, 'Fe': 4.0, 'O': 20.0, 'Al': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9658040.0,
                       'S_0': 485.0,
                       'V_0': 0.00019923,
...
class mcar (Mineral):
    def __init__(self):
        self.params = {'name': 'mcar',
                       'formula': {'H': 4.0, 'Mg': 1.0, 'Si': 2.0, 'Al': 2.0, 'O': 10.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4770850.0,
                       'S_0': 221.5,
                       'V_0': 0.0001059,
...
class fcar (Mineral):
    def __init__(self):
        self.params = {'name': 'fcar',
                       'formula': {'H': 4.0, 'Si': 2.0, 'Fe': 1.0, 'O': 10.0, 'Al': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4411490.0,
                       'S_0': 251.1,
                       'V_0': 0.00010695,
...
class deer (Mineral):
    def __init__(self):
        self.params = {'name': 'deer',
                       'formula': {'H': 10.0, 'Si': 12.0, 'Fe': 18.0, 'O': 50.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -18339500.0,
                       'S_0': 1650.0,
                       'V_0': 0.0005574,
...
class mu (Mineral):
    def __init__(self):
        self.params = {'name': 'mu',
                       'formula': {'H': 2.0, 'K': 1.0, 'Si': 3.0, 'Al': 3.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5976510.0,
                       'S_0': 292.0,
                       'V_0': 0.00014083,
...
class cel (Mineral):
    def __init__(self):
        self.params = {'name': 'cel',
                       'formula': {'Mg': 1.0, 'H': 2.0, 'K': 1.0, 'Al': 1.0, 'O': 12.0, 'Si': 4.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5834860.0,
                       'S_0': 290.0,
                       'V_0': 0.00013957,
...
class fcel (Mineral):
    def __init__(self):
        self.params = {'name': 'fcel',
                       'formula': {'H': 2.0, 'K': 1.0, 'Al': 1.0, 'O': 12.0, 'Si': 4.0, 'Fe': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5468630.0,
                       'S_0': 330.0,
                       'V_0': 0.0001407,
...
class pa (Mineral):
    def __init__(self):
        self.params = {'name': 'pa',
                       'formula': {'Na': 1.0, 'Si': 3.0, 'Al': 3.0, 'O': 12.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5942660.0,
                       'S_0': 277.0,
                       'V_0': 0.00013211,
...
class ma (Mineral):
    def __init__(self):
        self.params = {'name': 'ma',
                       'formula': {'H': 2.0, 'Ca': 1.0, 'Si': 2.0, 'Al': 4.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6241920.0,
                       'S_0': 265.0,
                       'V_0': 0.00012964,
...
class phl (Mineral):
    def __init__(self):
        self.params = {'name': 'phl',
                       'formula': {'Mg': 3.0, 'H': 2.0, 'K': 1.0, 'Al': 1.0, 'O': 12.0, 'Si': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6214610.0,
                       'S_0': 326.0,
                       'V_0': 0.00014964,
...
class ann (Mineral):
    def __init__(self):
        self.params = {'name': 'ann',
                       'formula': {'H': 2.0, 'K': 1.0, 'Al': 1.0, 'O': 12.0, 'Si': 3.0, 'Fe': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5143590.0,
                       'S_0': 420.0,
                       'V_0': 0.00015432,
...
class mnbi (Mineral):
    def __init__(self):
        self.params = {'name': 'mnbi',
                       'formula': {'H': 2.0, 'K': 1.0, 'Mn': 3.0, 'Al': 1.0, 'O': 12.0, 'Si': 3.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5475460.0,
                       'S_0': 433.0,
                       'V_0': 0.00015264,
...
class east (Mineral):
    def __init__(self):
        self.params = {'name': 'east',
                       'formula': {'Mg': 2.0, 'H': 2.0, 'K': 1.0, 'Al': 3.0, 'O': 12.0, 'Si': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6330120.0,
                       'S_0': 318.0,
                       'V_0': 0.00014738,
...
class naph (Mineral):
    def __init__(self):
        self.params = {'name': 'naph',
                       'formula': {'Mg': 3.0, 'Na': 1.0, 'Al': 1.0, 'O': 12.0, 'Si': 3.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6164670.0,
                       'S_0': 318.0,
                       'V_0': 0.0001445,
...
class tan (Mineral):
    def __init__(self):
        self.params = {'name': 'tan',
                       'formula': {'H': 2.0, 'Mg': 3.0, 'Si': 4.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5899790.0,
                       'S_0': 259.0,
                       'V_0': 0.00013665,
...
class clin (Mineral):
    def __init__(self):
        self.params = {'name': 'clin',
                       'formula': {'H': 8.0, 'Mg': 5.0, 'Si': 3.0, 'Al': 2.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -8908950.0,
                       'S_0': 437.0,
                       'V_0': 0.0002114,
...
class ames (Mineral):
    def __init__(self):
        self.params = {'name': 'ames',
                       'formula': {'H': 8.0, 'Mg': 4.0, 'Si': 2.0, 'Al': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -9040330.0,
                       'S_0': 412.0,
                       'V_0': 0.0002071,
...
class afchl (Mineral):
    def __init__(self):
        self.params = {'name': 'afchl',
                       'formula': {'H': 8.0, 'Mg': 6.0, 'Si': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -8727580.0,
                       'S_0': 439.0,
                       'V_0': 0.0002157,
...
class daph (Mineral):
    def __init__(self):
        self.params = {'name': 'daph',
                       'formula': {'H': 8.0, 'Si': 3.0, 'Fe': 5.0, 'O': 18.0, 'Al': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -7117950.0,
                       'S_0': 584.0,
                       'V_0': 0.0002162,
...
class mnchl (Mineral):
    def __init__(self):
        self.params = {'name': 'mnchl',
                       'formula': {'H': 8.0, 'Si': 3.0, 'Mn': 5.0, 'Al': 2.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -7699120.0,
                       'S_0': 595.0,
                       'V_0': 0.0002259,
...
class sud (Mineral):
    def __init__(self):
        self.params = {'name': 'sud',
                       'formula': {'H': 8.0, 'Mg': 2.0, 'Si': 3.0, 'Al': 4.0, 'O': 18.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -8626150.0,
                       'S_0': 395.0,
                       'V_0': 0.000203,
...
class fsud (Mineral):
    def __init__(self):
        self.params = {'name': 'fsud',
                       'formula': {'H': 8.0, 'Si': 3.0, 'Fe': 2.0, 'O': 18.0, 'Al': 4.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -7899960.0,
                       'S_0': 456.0,
                       'V_0': 0.000204,
...
class prl (Mineral):
    def __init__(self):
        self.params = {'name': 'prl',
                       'formula': {'H': 2.0, 'Si': 4.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5640520.0,
                       'S_0': 239.0,
                       'V_0': 0.00012804,
...
class fta (Mineral):
    def __init__(self):
        self.params = {'name': 'fta',
                       'formula': {'H': 2.0, 'Si': 4.0, 'Fe': 3.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4798850.0,
                       'S_0': 352.0,
                       'V_0': 0.00014225,
...
class tats (Mineral):
    def __init__(self):
        self.params = {'name': 'tats',
                       'formula': {'H': 2.0, 'Mg': 2.0, 'Si': 3.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6000930.0,
                       'S_0': 259.0,
                       'V_0': 0.0001351,
...
class kao (Mineral):
    def __init__(self):
        self.params = {'name': 'kao',
                       'formula': {'H': 4.0, 'Si': 2.0, 'Al': 2.0, 'O': 9.0},
                       'equation_of_state': 'hp_tmt',
...
class pre (Mineral):
    def __init__(self):
        self.params = {'name': 'pre',
                       'formula': {'H': 2.0, 'Ca': 2.0, 'Si': 3.0, 'Al': 2.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6202070.0,
                       'S_0': 292.8,
                       'V_0': 0.00014026,
...
class fpre (Mineral):
    def __init__(self):
        self.params = {'name': 'fpre',
                       'formula': {'H': 2.0, 'Ca': 2.0, 'Al': 1.0, 'O': 12.0, 'Si': 3.0, 'Fe': 1.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -5766490.0,
                       'S_0': 320.0,
                       'V_0': 0.000148,
...
class chr (Mineral):
    def __init__(self):
        self.params = {'name': 'chr',
                       'formula': {'H': 4.0, 'Mg': 3.0, 'Si': 2.0, 'O': 9.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4360800.0,
                       'S_0': 221.3,
                       'V_0': 0.00010746,
...
class glt (Mineral):
    def __init__(self):
        self.params = {'name': 'glt',
                       'formula': {'H': 4.0, 'Si': 2.0, 'Fe': 3.0, 'O': 9.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3297310.0,
                       'S_0': 310.0,
                       'V_0': 0.0001198,
...
class fstp (Mineral):
    def __init__(self):
        self.params = {'name': 'fstp',
                       'formula': {'H': 12.5, 'K': 0.5, 'Al': 2.0, 'O': 30.5, 'Si': 8.0, 'Fe': 5.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -12552150.0,
                       'S_0': 930.2,
                       'V_0': 0.00037239,
...
class mstp (Mineral):
    def __init__(self):
        self.params = {'name': 'mstp',
                       'formula': {'Mg': 5.0, 'H': 12.5, 'K': 0.5, 'Al': 2.0, 'O': 30.5, 'Si': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -14288210.0,
                       'S_0': 847.4,
                       'V_0': 0.00036577,
...
class atg (Mineral):
    def __init__(self):
        self.params = {'name': 'atg',
                       'formula': {'H': 62.0, 'Mg': 48.0, 'Si': 34.0, 'O': 147.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -71400990.0,
                       'S_0': 3620.0,
                       'V_0': 0.0017548,
...
class ab (Mineral):
    def __init__(self):
        self.params = {'name': 'ab',
                       'formula': {'Na': 1.0, 'Si': 3.0, 'Al': 1.0, 'O': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3935290.0,
                       'S_0': 207.4,
                       'V_0': 0.00010067,
...
class mic (Mineral):
    def __init__(self):
        self.params = {'name': 'mic',
                       'formula': {'K': 1.0, 'Si': 3.0, 'Al': 1.0, 'O': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3975410.0,
                       'S_0': 214.3,
                       'V_0': 0.00010871,
...
class an (Mineral):
    def __init__(self):
        self.params = {'name': 'an',
                       'formula': {'Ca': 1.0, 'Si': 2.0, 'Al': 2.0, 'O': 8.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4232600.0,
                       'S_0': 200.5,
                       'V_0': 0.00010079,
...
class kcm (Mineral):
    def __init__(self):
        self.params = {'name': 'kcm',
                       'formula': {'H': 2.0, 'K': 1.0, 'Si': 3.0, 'Al': 1.0, 'O': 9.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -4232700.0,
                       'S_0': 281.5,
                       'V_0': 0.00011438,
...
class ne (Mineral):
    def __init__(self):
        self.params = {'name': 'ne',
                       'formula': {'Na': 1.0, 'Si': 1.0, 'Al': 1.0, 'O': 4.0},
                       'equation_of_state': 'hp_tmt',
...
class nanal (Mineral):
    def __init__(self):
        self.params = {'name': 'nanal',
                       'formula': {'Na': 1.0, 'Mg': 2.0, 'Si': 1.0, 'Al': 5.0, 'O': 12.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6610270.0,
                       'S_0': 280.0,
                       'V_0': 0.00011322,
...
class canal (Mineral):
    def __init__(self):
        self.params = {'name': 'canal',
                       'formula': {'Ca': 1.0, 'Mg': 2.0, 'O': 12.0, 'Al': 6.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6840000.0,
                       'S_0': 257.6,
                       'V_0': 0.00011159,
...
class sdl (Mineral):
    def __init__(self):
        self.params = {'name': 'sdl',
                       'formula': {'Na': 8.0, 'Si': 6.0, 'Al': 6.0, 'O': 24.0, 'Cl': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -13407370.0,
                       'S_0': 910.0,
                       'V_0': 0.0004213,
...
class kls (Mineral):
    def __init__(self):
        self.params = {'name': 'kls',
                       'formula': {'K': 1.0, 'Si': 1.0, 'Al': 1.0, 'O': 4.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -2123210.0,
                       'S_0': 136.0,
                       'V_0': 6.052e-05,
...
class me (Mineral):
    def __init__(self):
        self.params = {'name': 'me',
                       'formula': {'C': 1.0, 'Ca': 4.0, 'Si': 6.0, 'Al': 6.0, 'O': 27.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -13841600.0,
                       'S_0': 752.0,
                       'V_0': 0.00033985,
...
class wrk (Mineral):
    def __init__(self):
        self.params = {'name': 'wrk',
                       'formula': {'H': 4.0, 'Ca': 1.0, 'Si': 4.0, 'Al': 2.0, 'O': 14.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -6662350.0,
                       'S_0': 380.0,
                       'V_0': 0.0001904,
...
class lmt (Mineral):
    def __init__(self):
        self.params = {'name': 'lmt',
                       'formula': {'H': 8.0, 'Ca': 1.0, 'Si': 4.0, 'Al': 2.0, 'O': 16.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -7262590.0,
                       'S_0': 465.0,
                       'V_0': 0.0002037,
...
class heu (Mineral):
    def __init__(self):
        self.params = {'name': 'heu',
                       'formula': {'H': 12.0, 'Ca': 1.0, 'Si': 7.0, 'Al': 2.0, 'O': 24.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -10545090.0,
                       'S_0': 783.0,
                       'V_0': 0.000317,
...
class stlb (Mineral):
    def __init__(self):
        self.params = {'name': 'stlb',
                       'formula': {'H': 14.0, 'Ca': 1.0, 'Si': 7.0, 'Al': 2.0, 'O': 25.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -10896630.0,
                       'S_0': 710.0,
                       'V_0': 0.0003287,
...
class anl (Mineral):
    def __init__(self):
        self.params = {'name': 'anl',
                       'formula': {'Na': 1.0, 'Si': 2.0, 'Al': 1.0, 'O': 7.0, 'H': 2.0},
                       'equation_of_state': 'hp_tmt',
                       'H_0': -3307050.0,
                       'S_0': 232.0,
                       'V_0': 9.74e-05,
