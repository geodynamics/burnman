...
class c2c_pyroxene(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.type = 'ideal'
        self.endmembers = [[hp_clinoenstatite(), '[Mg]2Si2O6'], [
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.endmembers = [[diopside(),
                           ...
                           [clinoenstatite(),
                            '[Mg][Mg][Si]2O6'],
                           [ca_tschermaks(),
                            '[Ca][Al][Si1/2Al1/2]2O6'],
                           [jadeite(),
                            '[Na][Al][Si]2O6']]
        self.enthalpy_interaction = [[0., 24.74e3, 26.e3, 24.3e3], [
            24.74e3, 0., 0.e3], [60.53136e3, 0.0], [10.e3]]
...
class garnet(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.enthalpy_interaction = [[0.0, 30.e3, 21.20278e3, 0.0], [
            0.0, 0.0, 0.0], [57.77596e3, 0.0], [0.0]]
...
class orthopyroxene(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.endmembers = [
            [
                enstatite(), '[Mg][Mg][Si]SiO6'], [
                ferrosilite(), '[Fe][Fe][Si]SiO6'], [
                mg_tschermaks(), '[Mg][Al][Al]SiO6'], [
                    ortho_diopside(), '[Ca][Mg][Si]SiO6']]
...
class plagioclase(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.type = 'symmetric'
        self.endmembers = [[anorthite(), '[Ca][Al]2Si2O8'], [
...
class mg_fe_ringwoodite(SolidSolution):
    ...
    def __init__(self, molar_fractions=None):
        ...
        self.type = 'symmetric'
        self.endmembers = [[mg_ringwoodite(), '[Mg]2SiO4'], [
