...
class Composite(Material):
    ...
    def set_fractions(self, fractions, fraction_type='molar'):
        ...
        if abs(total - 1.0) > 1e-12:
            warnings.warn(
                "Warning: list of fractions does not add up to one but %g. Normalizing." %
                total)
    ...
    def set_averaging_scheme(self, averaging_scheme):
        ...
        if isinstance(averaging_scheme, str):
    ...
    def internal_energy(self):
        ...
        """
        U = sum(
            phase.internal_energy *
            molar_fraction for (
                phase,
                molar_fraction) in zip(
                self.phases,
    ...
    def molar_mass(self):
        ...
        """
        return sum([phase.molar_mass * molar_fraction for (phase,
                                                           molar_fraction) in zip(self.phases, self.molar_fractions)])
    ...
    def thermal_expansivity(self):
        ...
        return self.averaging_scheme.average_thermal_expansivity(
            volumes, alphas)
    ...
    def heat_capacity_v(self):
        ...
        return self.averaging_scheme.average_heat_capacity_v(
            self.molar_fractions, c_v)
    ...
    def heat_capacity_p(self):
        ...
        return self.averaging_scheme.average_heat_capacity_p(
            self.molar_fractions, c_p)
