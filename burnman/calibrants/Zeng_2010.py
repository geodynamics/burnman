...
class Mo(Calibrant):
    """
    The Mo pressure standard from Zeng (2010), as reported by
    Huang et al. (2016; https://doi.org/10.1038/srep19923).
    """

    def __init__(self):
        def _pressure_Zeng_Mo(volume, temperature, params):
        ...
        Calibrant.__init__(self, _pressure_Zeng_Mo, "pressure", _params_Zeng_Mo)
