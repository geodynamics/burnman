...
"""
This package contains a large collection of calibrant models.
These calibrants are all derived from :mod:`burnman.Calibrant`,
and share the same interface. The models are taken
