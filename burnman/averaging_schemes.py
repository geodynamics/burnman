...
class HashinShtrikmanAverage(AveragingScheme):
    ...
    def average_bulk_moduli(self, volumes, bulk_moduli, shear_moduli):
        ...
        """
        return (self.upper.average_bulk_moduli(volumes,
                                               bulk_moduli,
                                               shear_moduli) + self.lower.average_bulk_moduli(volumes,
                                                                                              bulk_moduli,
                                                                                              shear_moduli)) / 2.0
    ...
    def average_shear_moduli(self, volumes, bulk_moduli, shear_moduli):
        ...
        """
        return (self.upper.average_shear_moduli(volumes,
                                                bulk_moduli,
                                                shear_moduli) + self.lower.average_shear_moduli(volumes,
                                                                                                bulk_moduli,
                                                                                                shear_moduli)) / 2.0
