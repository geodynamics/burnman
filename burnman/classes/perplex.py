...
class PerplexMaterial(Material):
    ...
    def _read_2D_perplex_file(self, filename):
        ...
        property_interpolators = {
            "rho": interp2d(pressures, temperatures, densities.T, bounds_error=True),
            "alpha": interp2d(
                pressures, temperatures, properties["alpha,1/K"].T, bounds_error=True
            ),
            "K_T": interp2d(
                pressures,
                temperatures,
                1.0e5 / properties["beta,1/bar"].T,
                bounds_error=True,
            ),
            "K_S": interp2d(
                pressures,
                temperatures,
                1.0e5 * properties["Ks,bar"].T,
                bounds_error=True,
            ),
            "G_S": interp2d(
                pressures,
                temperatures,
                1.0e5 * properties["Gs,bar"].T,
                bounds_error=True,
            ),
            "bulk_sound_velocity": interp2d(
                pressures,
                temperatures,
                1.0e3 * properties["v0,km/s"].T,
                bounds_error=True,
            ),
            "p_wave_velocity": interp2d(
                pressures,
                temperatures,
                1.0e3 * properties["vp,km/s"].T,
                bounds_error=True,
            ),
            "s_wave_velocity": interp2d(
                pressures,
                temperatures,
                1.0e3 * properties["vs,km/s"].T,
                bounds_error=True,
            ),
            "S": interp2d(
                pressures,
                temperatures,
                properties["s,J/K/kg"].T * molar_masses.T,
                bounds_error=True,
            ),
            "H": interp2d(
                pressures,
                temperatures,
                properties["h,J/kg"].T * molar_masses.T,
                bounds_error=True,
            ),
            "C_p": interp2d(
                pressures,
                temperatures,
                properties["cp,J/K/kg"].T * molar_masses.T,
                bounds_error=True,
            ),
