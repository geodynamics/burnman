...
try:
    import os
    if 'NUMBA_DISABLE_JIT' in os.environ and int(
...
chebyshev_representation = np.array([2.707737068327440945 /
                                     2.0, 0.340068135211091751, -
                                     0.12945150184440869e-01, 0.7963755380173816e-03, -
                                     0.546360009590824e-04, 0.39243019598805e-05, -
                                     0.2894032823539e-06, 0.217317613962e-07, -
                                     0.16542099950e-08, 0.1272796189e-09, -
                                     0.987963460e-11, 0.7725074e-12, -
                                     0.607797e-13, 0.48076e-14, -
                                     0.3820e-15, 0.305e-16, -
                                     0.24e-17])
...
def debye_fn(x):
    ...
    xi = Debye_T/T
    """
    sol = integrate.quad(lambda xi: (xi * xi * xi) /
                         (np.exp(xi) - 1.), 0.0, x)  # EQ B3
