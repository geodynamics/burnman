...
def tait_constants(params):
    ...
    """
    a = (1. + params['Kprime_0']) / (1. + \
         params['Kprime_0'] + params['K_0'] * params['Kdprime_0'])
    b = params['Kprime_0'] / params['K_0'] - \
        params['Kdprime_0'] / (1. + params['Kprime_0'])
    c = (1. + params['Kprime_0'] + params['K_0'] * params['Kdprime_0']) / (params['Kprime_0']
                                                                           * params['Kprime_0'] + params['Kprime_0'] - params['K_0'] * params['Kdprime_0'])
    return a, b, c
...
def bulk_modulus(pressure, params):
    ...
    """
    a, b, c = tait_constants(params)
    return params['K_0'] * (1. + b * (pressure - params['P_0'])) * \
        (a + (1. - a) * np.power((1. + b * (pressure - params['P_0'])), c))
