...
class SolidSolution(Mineral):
    ...
    def __init__(self, molar_fractions=None):
        ...
        if hasattr(self, 'type'):
            ...
            warnings.warn(
                "Warning, you have not set a solution model 'type' attribute for this solid solution.",
                stacklevel=2)
    ...
    def internal_energy(self):
        ...
        raise NotImplementedError(
            "need to implement internal_energy() for solid solution!")
        return None
    ...
    def partial_gibbs(self):
        ...
        Property specific to solid solutions.
        """
        return np.array([self.endmembers[i][0].gibbs for i in range(
            self.n_endmembers)]) + self.excess_partial_gibbs
    ...
    def molar_helmholtz(self):
        ...
        """
        raise NotImplementedError(
            "need to implement molar_helmholtz() for solid solution!")
        return None
    ...
    def molar_mass(self):
        ...
        """
        return sum([self.endmembers[i][0].molar_mass * self.molar_fractions[i]
                    for i in range(self.n_endmembers)])
    ...
    def molar_volume(self):
        ...
        Aliased with self.V
        """
        return sum([self.endmembers[i][0].molar_volume * self.molar_fractions[i]
    ...
    def isothermal_bulk_modulus(self):
        ...
        """
        return self.V * 1. / (sum([self.endmembers[i][0].V / (self.endmembers[i][
                              0].K_T) * self.molar_fractions[i] for i in range(self.n_endmembers)]))
    ...
    def shear_modulus(self):
        ...
        """
        G_list = np.fromiter(
            (e[0].G for e in self.endmembers),
            dtype=np.float,
    ...
    def thermal_expansivity(self):
        ...
        """
        return (1. / self.V) * sum([self.endmembers[i][0].alpha * self.endmembers[
            i][0].V * self.molar_fractions[i] for i in range(self.n_endmembers)])
    ...
    def heat_capacity_v(self):
        ...
        return self.heat_capacity_p - self.molar_volume * self.temperature * \
            self.thermal_expansivity * self.thermal_expansivity * self.isothermal_bulk_modulus
    ...
    def heat_capacity_p(self):
        ...
        """
        return sum([self.endmembers[i][0].heat_capacity_p *
                    self.molar_fractions[i] for i in range(self.n_endmembers)])
