...
atherm_params = {}
atherm_params['a'] = np.array([[ 0.47944268, -0.07305467, -0.07305467,  0.        ,  0.        ,
         0.        ],
       [-0.07305467,  0.47944268, -0.07305467,  0.        ,  0.        ,
         0.        ],
       [-0.07305467, -0.07305467,  0.47944268,  0.        ,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        ,  0.04445275,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        ,  0.        ,  0.04445275,
       ...
       [ 0.        ,  0.        ,  0.        ,  0.        ,  0.        ,
         0.04445275]])
atherm_params['b_1'] = np.array([[-0.77294538,  0.38647269,  0.38647269,  0.        ,  0.        ,
         0.        ],
       [ 0.38647269, -0.77294538,  0.38647269,  0.        ,  0.        ,
         0.        ],
       [ 0.38647269,  0.38647269, -0.77294538,  0.        ,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        , -0.17422384,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        ,  0.        , -0.17422384,
       ...
       [ 0.        ,  0.        ,  0.        ,  0.        ,  0.        ,
        -0.17422384]])
atherm_params['c_1'] = np.array([[5.81473511, 5.81473511, 5.81473511, 1.        , 1.        ,
        1.        ],
       [5.81473511, 5.81473511, 5.81473511, 1.        , 1.        ,
        1.        ],
       [5.81473511, 5.81473511, 5.81473511, 1.        , 1.        ,
        1.        ],
       [1.        , 1.        , 1.        , 1.13934342, 1.        ,
       ...
       [1.        , 1.        , 1.        , 1.        , 1.        ,
        1.13934342]])
atherm_params['b_2'] = np.array([[ 0.79772947, -0.39886474, -0.39886474,  0.        ,  0.        ,
         0.        ],
       [-0.39886474,  0.79772947, -0.39886474,  0.        ,  0.        ,
         0.        ],
       [-0.39886474, -0.39886474,  0.79772947,  0.        ,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        , -0.53002167,  0.        ,
         0.        ],
       [ 0.        ,  0.        ,  0.        ,  0.        , -0.53002167,
       ...
       [ 0.        ,  0.        ,  0.        ,  0.        ,  0.        ,
        -0.53002167]])
atherm_params['c_2'] = np.array([[ 5.81567299,  5.81567299,  5.81567299,  1.        ,  1.        ,
         1.        ],
       [ 5.81567299,  5.81567299,  5.81567299,  1.        ,  1.        ,
         1.        ],
       [ 5.81567299,  5.81567299,  5.81567299,  1.        ,  1.        ,
         1.        ],
       [ 1.        ,  1.        ,  1.        , -2.37105322,  1.        ,
...
def psi_func(f, Pth, params):
    ...
    dPsidf = dPsidf + Pth/1.e9*(params['b_3']*params['c_3']*np.exp(params['c_3']*f) + params['b_4']*params['c_4']*np.exp(params['c_4']*f))

    Psi = 0. + params['a']*f + params['b_1']*np.exp(params['c_1']*f) + params['b_2']*np.exp(params['c_2']*f)
    Psi = Psi + Pth/1.e9*(params['b_3']*np.exp(params['c_3']*f) + params['b_4']*np.exp(params['c_4']*f))

    dPsidPth = (params['b_3']*np.exp(params['c_3']*f) + params['b_4']*np.exp(params['c_4']*f))/1.e9
    return (Psi, dPsidf, dPsidPth)


def make_cubic_mineral_from_parameters(x):

    anisotropic_parameters = {'b_3': np.zeros((6, 6)),
                              'c_3': np.ones((6, 6)),
                              'b_4': np.zeros((6, 6)),
                              'c_4': np.ones((6, 6)),
                              **atherm_params}
    ...
    per.params['q_0'] = np.power(x[4], 2.)*q0
...
if run_fitting:
    ...
    i = 0
    min = 1.e10
    guesses = np.array([ 1.00827773e+00,  9.98856164e-01,  1.08401459e+00,  1.10777917e+00,
        7.94493025e-01,  2.04771439e-03,  8.76321298e-03,  1.87121476e+00,
        2.01075106e+00,  1.68704173e-04, -2.38606584e-03,  2.39190918e+01,
        5.33127227e+00])
...
if not run_fitting:
    parameters = np.array([ 1.00827773e+00,  9.98856164e-01,  1.08401459e+00,  1.10777917e+00,
        7.94493025e-01,  2.04771439e-03,  8.76321298e-03,  1.87121476e+00,
        2.01075106e+00,  1.68704173e-04, -2.38606584e-03,  2.39190918e+01,
        5.33127227e+00])
...
for T in temperatures:
    ...
    T_data = (np.array([[d[1], d[2], d[3], d[4]]
                        for d in per_data if np.abs(d[0] - T) < 1])/1.e9)[::3]
