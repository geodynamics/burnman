...
if run_fitting:
    ...
    guesses = np.array([ 1.00825474e+00,  9.92695934e-01,  1.08827120e+00,  1.12859229e+00,
        7.66721568e-01,  4.78290975e-01,  4.37591672e-02, -7.74683571e-01,
       -1.93952207e-01,  5.82744809e+00,  1.11294499e+00,  7.99641884e-01,
       -5.26577925e-01,  5.82314077e+00, -2.38281540e+00,  2.05834924e-03,
        1.17385211e-02,  1.72275539e+00,  1.88626859e+00,  1.84158921e-04,
       -3.87909545e-03,  2.27384829e+01,  4.13816434e+00])

    #sol = differential_evolution(cubic_misfit, bounds, args=[[[i, min]]], init='random')
...
if not run_fitting:
    ...
    parameters = np.array([ 1.00825474e+00,  9.92695934e-01,  1.08827120e+00,  1.12859229e+00,
        7.66721568e-01,  4.78290975e-01,  4.37591672e-02, -7.74683571e-01,
       -1.93952207e-01,  5.82744809e+00,  1.11294499e+00,  7.99641884e-01,
       -5.26577925e-01,  5.82314077e+00, -2.38281540e+00,  2.05834924e-03,
        1.17385211e-02,  1.72275539e+00,  1.88626859e+00,  1.84158921e-04,
...
print_table_for_mineral_constants_2(m, ['a', 'b_1', 'c_1', 'b_2', 'c_2', 'b_3', 'c_3', 'b_4', 'c_4'],
                                        [(1, 1), (4, 4)])
