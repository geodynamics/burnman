...
import burnman
from helper_solid_solution import SLB_2011_ZSB_2013_mg_fe_perovskite, other_ferropericlase
...
if __name__ == "__main__":
    ...
    def eval_material(amount_perovskite):
        ...
        #[rho_err,vphi_err,vs_err]=burnman.tools.compare_chifactor(mat_vs,mat_vphi,mat_rho,seis_vs,seis_vphi,seis_rho)
