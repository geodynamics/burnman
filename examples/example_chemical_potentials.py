...
if __name__ == "__main__":
    ...
    component_formulae_dict = [
        dictionarize_formula(f) for f in component_formulae]
    ...
    for i, T in enumerate(temperatures):
        ...
        muO2_FMQ_ONeill1987 = -587474. + 1584.427 * T - \
            203.3164 * T * np.log(T) + 0.092710 * T * T
    ...
    plt.plot(temperatures, log10fO2_FMQ_ONeill1987, 'k',
             linewidth=1., label='FMQ (O\'Neill (1987)')
    plt.plot(
        temperatures,
        log10fO2_FMQ,
        'b--',
        linewidth=2.,
        label='FMQ (HP 2011 ds62)')
    ...
    plt.plot(temperatures, log10fO2_Re_PO1994, 'k', linewidth=1.,
