...
if __name__ == "__main__":
    # pick from .prem() .slow() .fast() (see code/seismic.py)
    ...
    if whattodo == "profile2":
        ...
        [error(235.654790318e9,
               ...
               4.38543140228,
               306.635371217e9,
               1.42610871557) for i in range(0,
                                             10)]
