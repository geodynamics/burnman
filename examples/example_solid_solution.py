...
if __name__ == "__main__":
    ...
    for i, c in enumerate(comp):
        ...
        g3_excess_entropy[i] = -np.dot(molar_fractions,
                                       g3.solution_model._ideal_excess_partial_gibbs(T,
                                                                                     molar_fractions)) / T
    ...
    class mg_fe_ca_garnet_Ganguly(burnman.SolidSolution):
        ...
        def __init__(self, molar_fractions=None):
            ...
            self.enthalpy_interaction = [[[2117., 695.], [9834., 21627.], [
                12083., 12083.]], [[6773., 873.], [539., 539.]], [[0., 0.]]]
            self.volume_interaction = [[[0.07e-5, 0.], [0.058e-5, 0.012e-5], [
                0.04e-5, 0.03e-5]], [[0.03e-5, 0.], [0.04e-5, 0.01e-5]], [[0., 0.]]]
            self.entropy_interaction = [[[0., 0.], [5.78, 5.78], [
                7.67, 7.67]], [[1.69, 1.69], [0., 0.]], [[0., 0.]]]

            # Published values are on a 4-oxygen (1-cation) basis
            for interaction in [self.enthalpy_interaction,
