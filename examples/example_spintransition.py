...
if __name__ == "__main__":
    ...
    number_of_points = (
        40  # set on how many depth slices the computations should be done
    )
    ...
    mat_rho_LS, mat_vs_LS, mat_vphi_LS = rock.evaluate(
        ["density", "v_s", "v_phi"], seis_p, temperature
    )

    rock = minerals.Murakami_etal_2012.fe_periclase_HS()
    mat_rho_HS, mat_vs_HS, mat_vphi_HS = rock.evaluate(
        ["density", "v_s", "v_phi"], seis_p, temperature
    )

    rock = minerals.Murakami_etal_2012.fe_periclase()
    mat_rho_ON, mat_vs_ON, mat_vphi_ON = rock.evaluate(
        ["density", "v_s", "v_phi"], seis_p, temperature
    )
