...
if __name__ == "__main__":
    ...
    for T, color in [(1200., 'blue'),
        ...
        for d in [[ol, wad, np.linspace(x_fa_univariant, 0.001, 20)],
            ...
            m1.set_composition([1.-x_fwd_univariant, x_fwd_univariant])
            m2.set_composition([1.-x_fwd_univariant, x_fwd_univariant])
    ...
    ax[0].text(0.01, 14.2, 'wadsleyite', horizontalalignment='left',
