...
if __name__ == "__main__":
    ...
    lower_mantle = burnman.Layer(name="Lower Mantle", radii=6371.0e3 - depths)
    ...
    ax[0].plot(
        lower_mantle.pressures / 1.0e9,
        lower_mantle.v_p / 1.0e3,
        color="r",
        linestyle="-",
        marker="o",
        markerfacecolor="r",
    ...
    for i in range(4):
        ...
        ax[i].set_xlim(min(pressure) / 1.0e9, max(pressure) / 1.0e9)
