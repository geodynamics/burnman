...
if __name__ == "__main__":
    ...
    min1=minerals.SLB_MTZ.stishovite()
    min1.set_method('slb3')
    min2=minerals.SLB_MTZ.mgakimotoite()
    min2.set_method('slb3')
    rock1 = burnman.Composite([1.0], [min1])
    rock2 = burnman.Composite([1.0], [min2])
    ...
    density, vp, vs, vphi, K, G = burnman.velocities_from_rock(rock1, pressure, temperature)
    density2, vp2, vs2, vphi2, K2, G2 = burnman.velocities_from_rock(rock2, pressure, temperature)
    ...
    plt.plot(pressure/1.e9,vs2/1.e3,color='r',linestyle='-',marker='o', markerfacecolor='r',markersize=4,label='computation')
    ...
    plt.plot(pressure/1.e9,vp2/1.e3,color='r',linestyle='-',marker='o',markerfacecolor='r',markersize=4)
    ...
    plt.plot(pressure/1.e9,density2/1.e3,color='r',linestyle='-',marker='o', markerfacecolor='r',markersize=4)
