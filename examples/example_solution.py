...
if __name__ == "__main__":
    ...
    """
    g1 = burnman.Solution(name='Ideal pyrope-almandine garnet',
                          solution_type='ideal',
    ...
    plt.plot(comp, g1_gibbs / 1000., 'r-',
             linewidth=1., label='Ideal solution')
    ...
    '''
    g2 = burnman.Solution(name='Symmetric pyrope-almandine garnet',
    ...
    g3 = burnman.Solution(name='Symmetric pyrope-almandine-majorite garnet',
                          solution_type='symmetric',
                          endmembers=[[minerals.HP_2011_ds62.py(),
                                       '[Mg]3[Al]2Si3O12'],
                                      [minerals.HP_2011_ds62.alm(),
    ...
    g4 = burnman.Solution(name='garnet',
    ...
    g5 = burnman.Solution(name='Subregular pyrope-almandine-grossular '
                          ...
                          endmembers=[[minerals.HP_2011_ds62.py(),
                                      ...
                                      [minerals.HP_2011_ds62.spss(),
                                       '[Mn]3[Al]2Si3O12']],
                          energy_interaction=mult([[[2117., 695.],
                                                    [9834., 21627.],
                                                    [12083., 12083.]],
                                                   [[6773., 873.],
                                                    [539., 539.]],
                                                   [[0., 0.]]], 3.),
                          volume_interaction=mult([[[0.07e-5, 0.],
                                                    [0.058e-5, 0.012e-5],
                                                    [0.04e-5, 0.03e-5]],
                                                   [[0.03e-5, 0.],
                                                    [0.04e-5, 0.01e-5]],
                                                   [[0., 0.]]], 3.),
                          entropy_interaction=mult([[[0., 0.],
                                                     [5.78, 5.78],
                                                     [7.67, 7.67]],
                                                    [[1.69, 1.69],
                                                     [0., 0.]],
