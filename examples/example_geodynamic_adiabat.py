...
if __name__ == "__main__":
    ...
    # Just change "False" to "True" on the following line.
    if False:
        np.savetxt(
            "isentrope_properties.txt",
            X=np.array(
                [
                    depths_eq,
                    pressures_eq,
