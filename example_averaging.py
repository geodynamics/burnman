...
""" choose 'slb2' (finite-strain 2nd order shear modulus, 
    ...
    # plot vs
    fig=plt.figure()
    plt.plot(seis_p/1.e9,mat_vs3/1.e3,color='c',linestyle='-',marker='^',markersize=4,label='voigt')
    plt.plot(seis_p/1.e9,mat_vs4/1.e3,color='k',linestyle='-',marker='v',markersize=4,label='reuss')
    ...
    plt.plot(seis_p/1.e9,mat_vs3_norm,color='c',linestyle='-',marker='^',markersize=4,label='Voigt')
    plt.plot(seis_p/1.e9,mat_vs4_norm,color='k',linestyle='-',marker='v',markersize=4,label='Reuss')
    plt.plot(seis_p/1.e9,mat_vs1_norm,color='b',linestyle='-',marker='x',markersize=4,label='VRH')
    plt.plot(seis_p/1.e9,mat_vs2_norm,color='r',linestyle='--',marker='',markersize=4,label='linear')
    plt.plot(seis_p/1.e9,mat_vsa_norm,color='y',linestyle='-',marker='x',markersize=4,label='perovskite')
