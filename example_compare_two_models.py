...
if __name__ == "__main__":    
    ...
    mat_rho_1, mat_vp_1, mat_vs_1, mat_vphi_1, mat_K_1, mat_mu_1 = \
        burnman.velocities_from_rock(rock_1, seis_p_1, temperature_1, burnman.averaging_schemes.voigt_reuss_hill())
    ...
    mat_rho_2, mat_vp_2, mat_vs_2, mat_vphi_2, mat_K_2, mat_mu_2 = \
        burnman.velocities_from_rock(rock_2, seis_p_2, temperature_2, burnman.averaging_schemes.voigt_reuss_hill())    
